...
for i in range(0,20):
    magnitudes_oversampled =imageio.imread(rf'\DMDTC\Code\Frequency_domain_IR-SDE_recon\result_{i}.png')[0:800,:800]
    ...
    for k in range(trial):
        ...
        for percent in percent_list:
            ...
            sio.savemat(r'\DMDTC\Code\HIO-DNN\recon\New_result_num={}_percent={}.mat'.format(k, percent),{'result': Reconstruct_Field})
            cv2.imwrite(r'\DMDTC\Code\HIO-DNN\recon\New_FFD_ML_result_i={}_pecent={}_k={}.png'.format(i,percent,k),Reconstruct_Image_Amp/np.max(Reconstruct_Image_Amp)*255)